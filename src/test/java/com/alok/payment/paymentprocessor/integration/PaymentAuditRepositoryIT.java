...
/**
 * Integration tests for PaymentAuditRepository using Testcontainers.
 * Uses @DataJdbcTest for repository-specific testing which is lighter than @SpringBootTest.
 * Cannot extend AbstractIntegrationTest due to conflicting test context configurations.
 */
@DataJdbcTest
